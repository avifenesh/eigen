...
func Fields() []Field {
	return []Field{
		...
		{Key: "route_providers", Desc: "providers the auto-router may roam across (space-separated); empty = all credentialed providers when route=true", Dynamic: "providers", Multi: true},
