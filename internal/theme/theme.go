...
var studioPalette = Palette{
	Name:          "studio",
	Base:          lipgloss.AdaptiveColor{Dark: "#111416", Light: "#F4F6F8"},
	Surface:       lipgloss.AdaptiveColor{Dark: "#1A1F22", Light: "#FFFFFF"},
	Overlay:       lipgloss.AdaptiveColor{Dark: "#242B2E", Light: "#E0E5E9"},
	Text:          lipgloss.AdaptiveColor{Dark: "#E7ECEA", Light: "#17212B"},
	Dim:           lipgloss.AdaptiveColor{Dark: "#A5B0AD", Light: "#3D4C59"},
	Faint:         lipgloss.AdaptiveColor{Dark: "#74817D", Light: "#62717E"},
	Ghost:         lipgloss.AdaptiveColor{Dark: "#56625F", Light: "#7F8A94"},
	Accent:        lipgloss.AdaptiveColor{Dark: "#63C9BD", Light: "#0B736A"},
	Title:         lipgloss.AdaptiveColor{Dark: "#8DDED5", Light: "#075A54"},
	Ok:            lipgloss.AdaptiveColor{Dark: "#83BC8A", Light: "#2F7D4A"},
	Warn:          lipgloss.AdaptiveColor{Dark: "#D5AD61", Light: "#8A6418"},
	Err:           lipgloss.AdaptiveColor{Dark: "#D8796F", Light: "#B4443A"},
	Tool:          lipgloss.AdaptiveColor{Dark: "#B69AC0", Light: "#66558F"},
	Code:          lipgloss.AdaptiveColor{Dark: "#63C9BD", Light: "#086B63"},
	Link:          lipgloss.AdaptiveColor{Dark: "#78B7DB", Light: "#236B9A"},
	Heading:       lipgloss.AdaptiveColor{Dark: "#63C9BD", Light: "#0B736A"},
	Working:       lipgloss.AdaptiveColor{Dark: "#D58A5D", Light: "#B94F32"},
	Focus:         lipgloss.AdaptiveColor{Dark: "#D58A5D", Light: "#C55338"},
	Sel:           lipgloss.AdaptiveColor{Dark: "#D58A5D", Light: "#C55338"},
	OnBright:      lipgloss.AdaptiveColor{Dark: "#111416", Light: "#FFFFFF"},
	AddBg:         lipgloss.AdaptiveColor{Dark: "#17291E", Light: "#E3F2E8"},
	DelBg:         lipgloss.AdaptiveColor{Dark: "#301B1D", Light: "#F8E5E2"},
	SynKeyword:    lipgloss.AdaptiveColor{Dark: "#C99DDA", Light: "#694597"},
	SynType:       lipgloss.AdaptiveColor{Dark: "#DEB86E", Light: "#7B5A10"},
	SynFunc:       lipgloss.AdaptiveColor{Dark: "#78B7DB", Light: "#236B9A"},
	SynString:     lipgloss.AdaptiveColor{Dark: "#83BC8A", Light: "#2F7445"},
	SynNumber:     lipgloss.AdaptiveColor{Dark: "#E3A176", Light: "#A3432B"},
	SynComment:    lipgloss.AdaptiveColor{Dark: "#74817D", Light: "#6D7882"},
	SynPunct:      lipgloss.AdaptiveColor{Dark: "#A5B0AD", Light: "#4C5A66"},
	AccentBright:  lipgloss.AdaptiveColor{Dark: "#A7E9E1", Light: "#075A54"},
	FaintDim:      lipgloss.AdaptiveColor{Dark: "#46514E", Light: "#A8B0B7"},
	WorkingDim:    lipgloss.AdaptiveColor{Dark: "#8A593D", Light: "#D4937E"},
	WorkingBright: lipgloss.AdaptiveColor{Dark: "#EAB18D", Light: "#9C3825"},
	Spectrum: []lipgloss.AdaptiveColor{
		{Dark: "#63C9BD", Light: "#0B736A"},
		{Dark: "#78B7DB", Light: "#236B9A"},
		{Dark: "#B69AC0", Light: "#66558F"},
		{Dark: "#D58A5D", Light: "#C55338"},
	},
}
