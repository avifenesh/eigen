...
- **Key symbols:**
  ...
  - `Registry.MatchNiche(query)` / `MatchNicheInGroup(group,query)` / `matchNiche` — case-insensitive substring match over niche tools (name/description/group/capability), optionally group-scoped.
