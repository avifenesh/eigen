...
| terminal tab | Use embedded PTY terminal and release it cleanly. | `internal/tui:TestTUITerminalPanelFeatureJourney`, `internal/tui:TestTUIEveryRightPanelTabKeyboardJourney`, `internal/tui:TestTUIRightPanelCycleKeyboardJourney`, `internal/tui:TestTerminalTabStartsAndStops` |
