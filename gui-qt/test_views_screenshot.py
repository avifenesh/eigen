...
def capture_main_shell(client, clipboard_helper, highlighter, markdown_parser, terminal_helper):
    ...
    if home_badge.property("qaIsNavBadge") is not True:
        ...
        window.hide()
        return False
    if home_badge.property("qaTextFits") is not True or float(home_badge.property("qaHorizontalPadding") or 0) < 15.5 or float(home_badge.property("qaVerticalPadding") or 0) < 7.5:
        print(
