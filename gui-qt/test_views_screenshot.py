    ...
    def visit(item):
        ...
        if item.property("qaIsAppTag") is True:
            ...
            if visible and width > 0 and height > 0:
                ...
                if item.property("qaTextFits") is not True or horizontal_padding < 31.5 or vertical_padding < 9.5:
                    failures.append(
...
def main():
    ...
    def assert_home_tags(_view, root):
        for object_name in (
            ...
            if tag.property("qaTextFits") is not True or float(tag.property("qaHorizontalPadding") or 0) < 31.5 or float(tag.property("qaVerticalPadding") or 0) < 9.5:
