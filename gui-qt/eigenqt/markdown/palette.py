...
PALETTES = {
    ...
    "studio": MarkdownPalette(
        inline_background="#eef1f4",
        inline_text="#086b63",
        link="#236b9a",
        syntax_background="#f1f3f5",
        syntax_text="#202b35",
        syntax_keyword="#694597",
        syntax_type="#7b5a10",
        syntax_function="#236b9a",
        syntax_string="#2f7445",
        syntax_number="#a3432b",
        syntax_comment="#6d7882",
        syntax_punctuation="#4c5a66",
        syntax_builtin="#086b63",
        error="#b4443a",
    ),
