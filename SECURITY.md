...
- Bundled harness helpers (`computer-use-linux`, `agent-workspace-linux`) are installed only by explicit user action (`eigen harness install`, `eigen computer-use install`, or `eigen workspace install`).
